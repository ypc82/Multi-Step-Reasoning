...
#python paragraph_encoder/train_para_encoder.py --test_only --pretrained saved_model/20190424-4624abb5/model.mdl --data_dir /mnt/nfs/work1/mccallum/yipeichen/data/multi-step-reasoning/data --model_dir saved_model --src scitail --experiment_name question_answer --test_file_name test_new
